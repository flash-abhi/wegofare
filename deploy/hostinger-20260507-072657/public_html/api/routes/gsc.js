...
router.get('/sitemaps', verifyAdminToken, async (req, res) => {
  try {
    const mockData = {
      ...
      data: [
        {
          path: 'https://skytravelfare.com/sitemap.xml',
        ...
        {
          path: 'https://skytravelfare.com/sitemap-airlines.xml',
          lastSubmitted: '2025-11-20',
          status: 'Success',
          urlsSubmitted: 15,
          urlsIndexed: 15
        ...
        {
          path: 'https://skytravelfare.com/sitemap-blog.xml',
...
router.post('/connect', verifyAdminToken, async (req, res) => {
  try {
    ...
    gscData.siteUrl = siteUrl || 'https://skytravelfare.com';
